...
const botonNativo = document.getElementById("botonNativo");
botonNativo.addEventListener("click", () => {
    alert("click en el botón Nativo");
});

const botonQuery = document.querySelector("#botonQuery");
botonQuery.addEventListener("click", () => {
